...
export default function EditQuestionFromBankPage() {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
        setLoading(true);
        try {
            const [fetchedQuestion, fetchedQuestionCats] = await Promise.all([
  ...
  async function onSubmit(data: QuestionFormValues) {
    ...
    try {
        let questionData: Partial<any> = { ...data };
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Update the question details in the central bank.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="flex justify-end gap-4">
                 <Button type="button" variant="outline" onClick={() => router.push(`/admin/questions`)} disabled={isSubmitting}>
                    Cancel
                </Button>
