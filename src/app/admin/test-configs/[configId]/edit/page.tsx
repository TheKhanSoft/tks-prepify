        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <FormField control={form.control} name="slug" render={({ field }) => (<FormItem><FormLabel>URL Slug (Optional)</FormLabel><FormControl><Input {...field} value={field.value || ''} placeholder="e.g., gat-a-full-length-test" /></FormControl><FormDescription>If left blank, a slug will be generated from the name.</FormDescription><FormMessage /></FormItem>)} />
