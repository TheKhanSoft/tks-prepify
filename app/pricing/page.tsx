...
const PlanActionButton = ({ user, currentPlan, targetPlan, option, isCurrentPlan }: {
    ...
    // Determine the price of the same duration on the current plan, if it exists
    const currentPlanEquivalentPrice = currentPlan?.pricingOptions.find(p => p.months === option.months)?.price;
    const isUpgrade = user && currentPlan && currentPlanEquivalentPrice !== undefined && option.price > currentPlanEquivalentPrice;
    const isDowngrade = user && currentPlan && currentPlanEquivalentPrice !== undefined && option.price < currentPlanEquivalentPrice;
